...
- 2026-07-08: Proven speed pass: `deps::dependencies` now resolves modules without per-import thread spawn, `compile::vite_project_path` fast-paths `strip_prefix`, and `import_id::parse` fast-paths plain ids before percent decode. Release benchmark proof: `cargo test --release speed_ -- --nocapture` passed with `deps fast=22.482959ms slow=35.272125ms`, `paths fast=16.251ms slow=24.553791ms`, and `import_id fast=12.605541ms slow=13.571292ms`.
